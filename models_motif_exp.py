...
class LongRangeDNN(Model_DNN):
    ...
    def __init__(self, num_features=11, num_nodes=2, use_deep_CNN=False,
                  num_tasks=1, num_filters=3000,
                  num_filters_2=3000, num_filters_3=3000,
                  L1=0.0, dropout=0.4, verbose=2):
        ...
        for i in range(3):
            self.model.add(Dense(output_dim=3000, activation='relu'))
            #self.model.add(Dense(output_dim=1000))
    ...
    def train(self, X, y, validation_data):
        ...
        self.model.fit(
            ...
            #X, y, batch_size=64, nb_epoch=100,
...
class LongRangeDNN_ResNet(LongRangeDNN):
    def __init__(self, num_features=11, num_nodes=2, use_deep_CNN=False,
                  num_tasks=1, num_filters=3000,
                  num_filters_2=3000, num_filters_3=3000,
        ...
        def convresblock(self, y0, filter_size, nskipped=2):
            y0 = Convolution2D(filter_size, init='he_normal', W_regularizer=l1(L1))(y0)
            y = y0
...
class LongRangeDNN_FC(LongRangeDNN):
    def __init__(self, num_features=22, use_deep_CNN=False,
                  num_tasks=1, num_filters=(8000, 8000, 8000, 8000, 8000, 8000),
                  #num_tasks=1, num_filters=(5000, 5000, 5000, 5000, 5000, 5000, 5000, 5000, 5000, 5000, 5000, 5000, 5000),
                  L1=0.0001, dropout=0.0, verbose=2):
        self.num_features = num_features
...
class LongRangeDNN_FC_ResNet(LongRangeDNN):
    def __init__(self, num_features=22, use_deep_CNN=False,
                  num_tasks=1, num_filters=(5000, 5000, 5000, 5000, 5000, 5000, 5000, 5000, 5000, 5000, 5000, 5000),
                  L1=0.0, dropout=0.0, verbose=2):
        self.num_features = num_features
        self.input_shape = (num_features,)
        self.num_tasks = num_tasks
